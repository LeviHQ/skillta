    ...
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
      ...
      <tr><td style="padding:32px 40px 8px;">
        ...
        <p style="margin:12px 0 0;font-size:15px;color:#555770;line-height:1.7;">
          You've used all <strong>${dailyLimit} AI Resume Reviews</strong> for today. Loving the effort you're putting into your resume — that's exactly how careers get made. 🚀
        </p>
        <p style="margin:12px 0 0;font-size:15px;color:#555770;line-height:1.7;">
      ...
      <tr><td style="padding:20px 40px 8px;">
        <div style="background:#f8f9fc;border-radius:12px;padding:22px;">
          ...
          <p style="margin:6px 0;font-size:14px;color:#555770;line-height:1.7;">
            🎯 <a href="https://www.skillta.tech/quiz" style="color:#7c3aed;text-decoration:none;font-weight:600;">AI Career Quiz</a> — find your best-fit tech role<br/>
            💰 <a href="https://www.skillta.tech/salary-predictor" style="color:#7c3aed;text-decoration:none;font-weight:600;">Salary Predictor</a> — 2026 market data<br/>
            🗺️ <a href="https://www.skillta.tech/roadmaps" style="color:#7c3aed;text-decoration:none;font-weight:600;">Roadmap Library</a> — 60+ tech paths<br/>
            ⚖️ <a href="https://www.skillta.tech/compare" style="color:#7c3aed;text-decoration:none;font-weight:600;">Compare Careers</a> — side-by-side<br/>
            🎤 <a href="https://www.skillta.tech/interview-prep" style="color:#7c3aed;text-decoration:none;font-weight:600;">Interview Prep</a> — role-specific practice
          </p>
        </div>
      </td></tr>
      <tr><td style="padding:24px 40px 28px;text-align:center;">
        <a href="https://www.skillta.tech/resume-reviewer" style="display:inline-block;background:linear-gradient(135deg,#26c6b0,#7c3aed);color:#fff;text-decoration:none;font-size:15px;font-weight:600;padding:14px 36px;border-radius:10px;">Come back tomorrow →</a>
