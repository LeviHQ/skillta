      ...
      <tr><td style="padding:20px 40px 8px;">
        <div style="background:#f8f9fc;border-radius:12px;padding:22px;">
          ...
          <p style="margin:6px 0;font-size:14px;color:#555770;line-height:1.7;">
            💰 <a href="https://www.skillta.tech/salary-predictor" style="color:#7c3aed;text-decoration:none;font-weight:600;">Salary Predictor</a> — AI insights, 2026 market data<br/>
            🎯 <a href="https://www.skillta.tech/interview-prep" style="color:#7c3aed;text-decoration:none;font-weight:600;">Interview Prep</a> — role-specific practice<br/>
            ...
            📄 <a href="https://www.skillta.tech/resume-reviewer" style="color:#7c3aed;text-decoration:none;font-weight:600;">AI Resume Reviewer</a> — instant ATS score &amp; rewrites<br/>
            📚 <a href="https://www.skillta.tech/blog" style="color:#7c3aed;text-decoration:none;font-weight:600;">Blog</a> — trending tech deep-dives
          </p>
        </div>
      </td></tr>
      <tr><td style="padding:24px 40px 28px;text-align:center;">
        <a href="https://www.skillta.tech/dashboard" style="display:inline-block;background:linear-gradient(135deg,#26c6b0,#7c3aed);color:#fff;text-decoration:none;font-size:15px;font-weight:600;padding:14px 36px;border-radius:10px;">Go to Dashboard →</a>
